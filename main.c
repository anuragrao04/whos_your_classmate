...
int main(int argc, char *argv[]) {
  ...
  // this file will contain the number of classes, total number of students and
  // the students, their srn and their gpa. This can be in any order
